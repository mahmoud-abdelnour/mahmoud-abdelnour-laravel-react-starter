...
const ReactSelect = ( props ) => {
    const { title, placeholder, data, defaultValue, onChange, errors, value, isRequired, multiLanguageOption, addSearchItems } = props;
    ...
    return (
        <Form.Group className='form-group w-100' controlId='formBasic'>
            ...
            <Select
                ...
                isDisabled={ isOptionDisabled ? true : false}
            />
